"use strict";
/**
 * Rosetta Translator - Interface for provider format translation
 *
 * @aiInstructions
 * All providers translate to/from Rosetta format (the universal middle layer).
 * This avoids N×N matrix of provider-to-provider translators.
 *
 * Provider Format ↔ Rosetta Format ↔ Provider Format
 *
 * @aiExample
 * ```typescript
 * const translator = new AnthropicRosettaTranslator();
 * const rosettaContext = translator.toRosetta(anthropicMessages);
 * const geminiMessages = geminiTranslator.fromRosetta(rosettaContext);
 * ```
 */
...
//# sourceMappingURL=IRosettaTranslator.js.map