...
exports.OpenAIOpenAITranslator = void 0;
/**
 * OpenAI OpenAI Translator
 */
class OpenAIOpenAITranslator {
    getProviderId() {
        return 'openai';
    }
    /**
    ...
    toOpenAI(openaiRequest) {
        ...
        for (const msg of openaiRequest.messages) {
            ...
            messages.push({
                role: (msg.role === 'tool' ? 'user' : msg.role), // Map tool → user
                content
            });
        }
        return {
     ...
     */
    responseToOpenAI(openaiResponse) {
...
exports.OpenAIOpenAITranslator = OpenAIOpenAITranslator;
//# sourceMappingURL=OpenAIOpenAITranslator.js.map